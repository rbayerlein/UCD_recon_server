function sum_sino(outfolder, frame)

encoding_type = 'int32'; 

sino_size = [549, 420, 1343]; 
...
for n = 1:8
n
	sino_name_p = ['sinogram_ssrb_f', num2str(frame), '_prompts.', num2str(n), '.raw'];
	sino_name_r = ['sinogram_ssrb_f', num2str(frame), '_randoms.', num2str(n), '.raw'];  
...
sino_name_p = ['sinogram_ssrb_f', num2str(frame), '_prompts.raw'];
sino_name_r = ['sinogram_ssrb_f', num2str(frame), '_randoms.raw'];
