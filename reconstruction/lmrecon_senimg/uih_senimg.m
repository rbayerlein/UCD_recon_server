...
attvoxelsize_x = 2.7344; %2.44;
attvoxelsize_z = 2.344; %2.85;
...
for blockringdiff_no = 0:blockringdiff
...
fwrite(fopen(strcat('uih3_sensimage_MM-voxelsize2_85mm-sum-brd0_4-single.smap'), 'w'), bp1, 'single');
fclose('all');
