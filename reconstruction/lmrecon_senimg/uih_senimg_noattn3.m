...
fwrite(fopen(strcat('uih3_sensimage_', num2str(num_voxels), 's', num2str(num_slices), '-voxelsize2_85mm-sum-brd0_4-single_noattn2.smap'), 'w'), bp1, 'single');
fclose('all');
