function [fname_s_scaled] = sinogram_scaling(iteration_num, fname_pd, simulation_dir)
...
basename_ts = [simulation_dir, '/history/f', num2str(iteration_num)];
basename_scaled = ['f', num2str(iteration_num), '_scatters'];

fname_t = [basename_ts, '/f', num2str(iteration_num), '.', num2str(iteration_num), '_trues.sino4d'];
fname_s = [basename_ts, '/f', num2str(iteration_num), '.', num2str(iteration_num), '_scatters.sino4d'];
